 ...
 *
 * Originally the site's `/` route. Moved here once the real marketing
 * homepage shipped — nothing in the app links to this route, but it stays
 * for design QA rather than being deleted.
 */
  ...
  return (
    <PageShell className="gap-12 sm:gap-16">
      <PageHeader
        ...
        description="This page proves the pinned stack, design tokens, and shared component primitives are wired up correctly. It is a token showcase, not the marketing page."
      >
